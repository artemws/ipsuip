...
void choose_your_fate(int argc, char **argv)
{
    ...
    if (cmd.size() == 2)
    {
        ...
        /// MAINLAND COUNTRY
        /// ////////////////////////////////////////////////
        else if (cmd[1] == mainland || cmd[1] == mainland_sh || cmd[1] == country || cmd[1] == country_sh)
        {
    ...
    /// //////////////////////////////////////////////////////
    else if ((cmd.size() == 5 && cmd[1] == all && (cmd[2] == country_sh || cmd[2] == mainland_sh) && (cmd[3] == output_sh || cmd[3] == output)) || (cmd.size() == 5 && cmd[1] == all && (cmd[2] == country || cmd[2] == mainland) && (cmd[3] == output_sh || cmd[3] == output)))
    {
        Timer timer;
    ...
    else if ((cmd.size() == 5 && cmd[3] == output_sh) || (cmd.size() == 5 && cmd[3] == output))
    {
        ...
        if ((cmd[1] == mainland && ipsuip::codes_mainlands.contains(cmd[2])) || (cmd[1] == mainland_sh && ipsuip::codes_mainlands.contains(cmd[2])))
        {
        ...
        else if ((cmd[1] == country && ipsuip::codes_countries.contains(cmd[2])) || (cmd[1] == country_sh && ipsuip::codes_countries.contains(cmd[2])))
        {
            ipsuip::run_init(cmd[2],
                             cmd[4],
                             ipsuip::map_code(ipsuip::country_code_data),
