...
namespace ipsuip
{
    ...
    std::stringstream ss1(get("suip.biz", "/?act=all-country-ip&country=AM&all-download"));

    // All IP ranges of Oceania континент страничка html
    std::stringstream ss2(get("suip.biz", "/?act=all-country-ip&continent=OC&all"));

    // IP addresses lists. All Cities of Lovech провинции скачивание сразу
    std::stringstream ss3(get("suip.biz", "/?act=all-country-ip&province=Lovech&all-download"));
